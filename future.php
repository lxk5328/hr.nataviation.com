...
$p1 = $scheduleDate;
if (isset($_REQUEST['s'])) { $p1 = $_REQUEST['s']; $scheduleDate = $p1; }

printSchedule($p0, $p1, $lockScheduleView);
scheduleOpenWorkFlowCheck($p0);
